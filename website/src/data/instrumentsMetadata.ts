...
const instrumentsMetadata: Record<string, InstrumentMeta> = {
  ...
  Ravanhatha: {
    name: 'Ravanhatha',
    image: makeImage('ravanhatha.jpg'),
  ...
  Nadaswaram: {
    name: 'Nadaswaram',
    image: makeImage('nadaswaram.jpg'),
