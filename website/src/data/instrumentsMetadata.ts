...
const makeImage = (name: string) => `https://via.placeholder.com/640x420?text=${encodeURIComponent(name)}`;

const instrumentsMetadata: Record<string, InstrumentMeta> = {
  Sarangi: {
    name: 'Sarangi',
    image: makeImage('Sarangi'),
    description:
