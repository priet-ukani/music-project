...
export const musicalTimeline: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: 'Development of Carnatic music system in South India with temple music and devotional compositions gaining prominence. Establishment of the seven swaras (Sa, Ri, Ga, Ma, Pa, Dha, Ni) and foundational tala systems.',
    category: 'tradition',
    importance: 'high',
    relatedRegions: ['tamil-nadu', 'kerala', 'karnataka', 'andhra-pradesh'],
  },
  {
    id: 'natya-shastra-swaras',
    year: 200,
    title: 'Natya Shastra - Swara and Tala Systems',
    description: 'Bharata Muni\'s Natya Shastra documents the systematic use of swaras (notes) with their positions (swarasthan), shruti (microtonal intervals), and tala (rhythm) systems. Establishes the foundation for all Indian classical music with concepts of Mandra, Madhya, and Tara sthayi (octaves).',
    category: 'period',
    importance: 'high',
    relatedRegions: ['tamil-nadu', 'karnataka', 'uttar-pradesh'],
  },
  ...
  },
  {
    ...
    description: 'Devotional music becomes central to religious practice. Saints like Kabir, Meera, and Tulsidas compose devotional poetry. Kabir\'s doha "Guru Gobind Dou Khade..." emphasizes the primacy of the guru (teacher) in spiritual and musical learning, establishing the guru-shishya parampara tradition.',
    category: 'movement',
    importance: 'high',
    relatedRegions: ['rajasthan', 'uttar-pradesh', 'maharashtra', 'tamil-nadu'],
  },
  {
    id: 'kabir-guru-poetry',
    year: 1440,
    title: 'Kabir\'s Poetry on Guru-Shishya Tradition',
    description: 'Kabir composes devotional poetry emphasizing the guru\'s role in spiritual and musical learning. His famous doha "Guru Gobind Dou Khade..." teaches that the guru shows the path to God, establishing the foundation of guru-shishya parampara in Indian music education.',
    category: 'movement',
    importance: 'high',
  ...
  // Early Modern Period (1700-1900)
  {
    ...
    description: 'Syama Sastri, Tyagaraja, and Muthuswami Dikshitar (Carnatic Trinity) revolutionize South Indian classical music with thousands of compositions. They establish the kriti form with Pallavi, Anupallavi, and Charanam sections, and demonstrate mastery of complex ragas and tala systems.',
    category: 'artist',
    importance: 'high',
  ...
  },
  {
    id: 'tyagaraja-birth',
    year: 1767,
    title: 'Birth of Sri Tyagaraja',
    description: 'Sri Tyagaraja born in Thiruvarur, Tamil Nadu. He will compose thousands of kritis including the Pancharatna Kritis (Five Gems) like "Jagadananda Karaka" (Raga Nāṭṭai, Tala Adi). His works demonstrate mastery of ragas like Vachaspati, Charukesi, and Shankarabharanam, with complex swara patterns and tala structures using Tisra, Chatushra, Khanda, Misra, and Sankeerna gatis.',
    category: 'artist',
    importance: 'high',
    region: 'tamilnadu',
    relatedRegions: ['tamil-nadu', 'andhra-pradesh', 'karnataka'],
  ...
  {
    id: 'tyagaraja-pancharatna',
    year: 1800,
    title: 'Tyagaraja Composes Pancharatna Kritis',
    description: 'Tyagaraja composes the Pancharatna Kritis (Five Gems), including "Jagadananda Karaka" in Raga Nāṭṭai with Tala Adi. These compositions feature complex swara patterns demonstrating all seven swaras (Sa, Ri, Ga, Ma, Pa, Dha, Ni) and intricate tala structures. The kriti form with Pallavi, Anupallavi, and multiple Charanams becomes the standard for Carnatic music.',
    category: 'artist',
    importance: 'high',
    region: 'tamilnadu',
    relatedRegions: ['tamil-nadu', 'andhra-pradesh', 'karnataka'],
