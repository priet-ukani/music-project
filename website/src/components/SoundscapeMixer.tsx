...
import type { InstrumentTrack } from '../types/music';
...
const SoundscapeMixer: React.FC<SoundscapeMixerProps> = ({ regionId, regionName, regionColor, initialTracks = [], onClose }) => {
    const [tracks, setTracks] = useState<InstrumentTrack[]>(initialTracks);
                    ...
                    <div className="p-6 max-h-[calc(90vh-200px)] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            {tracks.map((track) => (
                                <div
                                    key={track.id}
                                    className={`border-2 rounded-lg p-4 transition-all ${track.isMuted ? 'border-gray-200 bg-gray-50' : 'border-gray-300 bg-white shadow-sm'
                                        }`}
                                >
                                    <div className="flex items-center justify-between mb-3">
                                        <div className="flex items-center gap-3">
                                            <button
                                                ...
                                                className={`p-2 rounded-lg transition-colors ${track.isMuted
